...
use crate::kiroshi::{Detail, Error, Image, Model, Quality, Rectangle, Sampler, Seed, Steps};
use crate::widget::{container, labeled_slider, optic};
...
use iced::{Center, Color, Element, Fill, FillPortion, Font, Task};
...
impl Generator {
    ...
    pub fn update(&mut self, message: Message) -> Task<Message> {
        match message {
            ...
            Message::ModelsListed(Err(error)) | Message::ModelSettingsFetched(Err(error)) => {
                // TODO: Logging
                dbg!(error);
    ...
    pub fn view(&self) -> Element<Message> {
        ...
        row![container(image_and_controls).center_y(Fill), prompts]
            .spacing(10)
            .into()
    }
}
